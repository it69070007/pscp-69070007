...
Input: รับข้อความที่เป็นตัวอักษรภาษาอังกฤษยาว 5 ตัวอักษร
Output: ข้อความที่ถูกสลับที่แบบกลับด้านและเป็นตัวพิมพ์เล็กทุกตัวอักษร
Constraints: ต้องสลับที่แบบให้ตัวอักษรสุดท้ายเป็นตัวแรก
```
...
```text
เหมือนกันกับแผนแรก เพราะเป็นวิธีการที่ทำให้ได้ผลลัพธ์ที่ถูกต้องตามที่ต้องการ
```
