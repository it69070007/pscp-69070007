...
```text
โจทย์ให้รับข้อความที่เป็นต้นทาง ปลายทาง และค่าน้ำหนักพัสดุ แล้วแสดงผลราคาการนําส่งพัสดุ
Input:
บรรทัดที่ 1 รับข้อความแทนค่า ต้นทาง ปลายทาง
บรรทัดที่ 2 รับค่าน้ำหนักพัสดุ
Output:
ราคาการนําส่งพัสดุที่ได้จากข้อมูลนําเข้า ถ้าเส้นทางที่ระบุไม่อยู่ในตารางจะแสดงข้อความว่า Error
Constraints:
ต้นทาง ปลายทาง เป็นภาษาอังกฤษตัวพิมพ์ใหญ่เท่านั้น
```
...
```text
Step 1: รับค่าข้อความ ต้นทาง ปลายทาง
Step 2: รับค่าน้ำหนักพัสดุ
Step 3: ตรวจสอบว่าต้นทางคือ BKK และปลายทางคือ CNX ใช่หรือไม่
Step 4: ถ้าใช่ จะแสดงผล น้ำหนักพัสดุ * 30 + 10 รูปแบบทศนิยม 2 ตำแหน่ง
Step 5: ถ้าไม่ ตรวจสอบว่าต้นทางคือ BKK และปลายทางคือ PKT ใช่หรือไม่
Step 6: ถ้าใช่ จะแสดงผล น้ำหนักพัสดุ * 50 + 25 รูปแบบทศนิยม 2 ตำแหน่ง
Step 7: ถ้าไม่ ตรวจสอบว่าต้นทางคือ CNX และปลายทางคือ UBP ใช่หรือไม่
Step 8: ถ้าใช่ จะแสดงผล น้ำหนักพัสดุ * 40 + 15 รูปแบบทศนิยม 2 ตำแหน่ง
Step 9: ถ้าไม่ ตรวจสอบว่าต้นทางคือ UBP และปลายทางคือ BKK ใช่หรือไม่
Step 10: ถ้าใช่ จะแสดงผล น้ำหนักพัสดุ * 40 + 20 รูปแบบทศนิยม 2 ตำแหน่ง
Step 11: ถ้าไม่ ตรวจสอบว่าต้นทางคือ UBP และปลายทางคือ PKT ใช่หรือไม่
Step 12: ถ้าใช่ จะแสดงผล น้ำหนักพัสดุ * 70 + 40 รูปแบบทศนิยม 2 ตำแหน่ง
Step 13: ถ้าไม่ ตรวจสอบว่าต้นทางคือ PKT และปลายทางคือ CNX ใช่หรือไม่
Step 14: ถ้าใช่ จะแสดงผล น้ำหนักพัสดุ * 60 + 30 รูปแบบทศนิยม 2 ตำแหน่ง
Step 15: ถ้าไม่ จะแสดงผลข้อความว่า Error
```
...
```text
เหมือนกันกับแผนแรก คือนำต้นทางกับปลายทางมาตรวจสอบ ถ้าเข้าเงื่อนไขก็จะแสดงผลราคาการนําส่งพัสดุที่คำนวณตามเงื่อนไขนั้น ๆ
```
...
```text
เป็นกรณีที่ค่าน้ำหนักพัสดุเป็นจำนวนเต็ม
```
...
```text
เป็นกรณีที่ค่าน้ำหนักพัสดุเป็นทศนิยม
```
...
```text
เป็นกรณีที่เส้นทางที่ระบุไม่อยู่ในตาราง
```
