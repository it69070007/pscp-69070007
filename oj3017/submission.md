...
Constraints:
มีการกำหนดขั้นต่ำของค่าบริการไว้ 50 บาท และไม่เกิน 1000 บาท ควรสร้างเงื่อนไขไว้เมื่อ 10% ของค่าอาหารและเครื่องดื่มไม่ถึง 50 บาท หรือเกิน 1000 บาท เพื่อปรับให้อยู่ในขอบเขต 50 <= ค่าบริการ <= 1000
```
