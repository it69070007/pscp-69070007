...
Constraints: 
ความยาวของข้อความที่รับมายาว 5 ตัวอักษร ต้องสลับที่แบบสลับจากหลังมาหน้าและต้องแปลงเป็นตัวพิมพ์เล็กเท่านั้น
```
...
Step 3: แสดงข้อความออกมาโดยใช้ index slicing ให้ step เป็น -1 เพื่อให้แสดงตัวอักษรสุดท้ายไล่มาจนถึงตัวแรก
```
...
```text
เหมือนกันกับแผนแรก แปลงข้อความเป็นพิมพ์เล็ก ใช้ index slicing ให้ step เป็น -1
```
