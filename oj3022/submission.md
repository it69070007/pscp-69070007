...
```text
โจทย์ให้รับค่าอุณหภูมิ หน่วยอุณหภูมิที่เป็นอยู่ และหน่วยอุณหภูมิที่ต้องการ แล้วแสดงผลเป็นค่าอุณหภูมิตามหน่วยที่ต้องการ
Input:
บรรทัดที่ 1 รับค่าอุณหภูมิเป็นจำนวนจริง
บรรทัดที่ 2 อักษร C, F, K, R แทนหน่วยอุณหภูมิของบรรทัดที่ 1
บรรทัดที่ 3 อักษร C, F, K, R แทนหน่วยอุณหภูมิที่ต้องการ
Output:
ค่าอุณหภูมิที่แปลงเป็นหน่วยที่ต้องการ ในรูปแบบทศนิยม 2 ตำแหน่ง
Constraints:
ค่าอุณหภูมิที่รับมาเป็นจำนวนจริง หน่วยอุณหภูมิที่รับมาเป็นตัวอักษร C, F, K, R
```
...
```text
Step 1: รับค่าอุณหภูมิ หน่วยของอุณหภูมิที่เป็นอยู่ และหน่วยของอุณหภูมิที่ต้องการ
Step 2: แปลงค่าอุณหภูมิให้กลายเป็นหน่วยเซลเซียส
Step 3: แปลงค่าอุณหภูมิจากหน่วยเซลเซียสให้กลายเป็นหน่วยที่ต้องการ
Step 4: แสดงค่าอุณหภูมิในหน่วยที่ต้องการเป็นทศนิยม 2 ตำแหน่ง 
```
...
```text
เหมือนกันกับแผนแรก คือการแปลงค่าอุณหภูมิที่รับมาให้เป็นหน่วยเซลเซียสก่อนที่จะนำไปแปลงเป็นหน่วยที่ต้องการ
```
...
```text
เป็นกรณีที่หน่วยที่เป็นอยู่และหน่วยที่ต้องการ ไม่มีตัวไหนเป็นหน่วยเซลเซียส
```
...
```text
เป็นกรณีที่หน่วยที่เป็นอยู่คือเซลเซียส และหน่วยที่ต้องการเป็นหน่วยอื่น
```
...
```text
เป็นกรณีที่หน่วยที่เป็นอยู่คือหน่วยอื่น และหน่วยที่ต้องการเป็นเซลเซียส
```
