...
```text
โจทย์ให้รับจำนวนเริ่มต้นและจำนวนสุดท้าย แล้วให้แสดงจำนวนเฉพาะทั้งหมดในช่วงนั้น พร้อมแสดงว่ามีกี่จำนวน
Input:
รับจำนวนเริ่มต้นและจำนวนสุดท้ายที่ต้องการหาจำนวนเฉพาะ
Output:
แสดงจำนวนเฉพาะ และจำนวนของจำนวนเฉพาะทั้งหมดในช่วงนั้น
Constraints:
ต้องพิจารณาจำนวนเริ่มต้นและจำนวนสุดท้ายด้วยว่าเป็นจำนวนเฉพาะหรือไม่
```
...
```text
Step 1: รับจำนวนเริ่มต้นและจำนวนสุดท้ายที่ต้องการหาจำนวนเฉพาะ
Step 2: ถ้าจำนวนเริ่มต้นน้อยกว่า 2 ให้กำหนดจำนวนเริ่มต้นเป็น 2
Step 3: สร้าง list เปล่ามาเก็บจำนวนเฉพาะทั้งหมด
Step 4: นำ i มา loop โดยมีค่าเริ่มต้นเท่ากับ จำนวนเริ่มต้น และสิ้นสุดที่ จำนวนสุดท้ายที่รับมา
Step 5: ภายใน loop กำหนดให้ตัวแปร prime มีค่าเป็นจริง
Step 6: กำหนดให้ n = i - 1
Step 7: สร้างอีก loop นึงซ้อนอยู่ โดยจะทำงานเมื่อ n > 1 และ prime มีค่าเป็นจริง
Step 8: ภายใน loop นั้นจะตรวจสอบว่า i % n ลงตัวหรือไม่
Step 9: ถ้าใช่จะเปลี่ยนค่า prime มีค่าเป็นเท็จ
Step 10: n มีค่าลดลง 1 ไปเรื่อยๆใน loop
Step 11: เมื่อออกจาก loop นี้แล้ว จะตรวจสอบว่า prime มีค่าเป็นจริงหรือไม่
Step 12: ถ้าใช่ จะเพิ่มเลขที่มีค่า i ลงใน list
Step 13: เมื่อออกจาก loop นั้นอีกทีจะตรวจสอบว่าใน list มีเลขอยู่หรือไม่
Step 14: ถ้าใช่ จะแสดงสมาชิกทั้งหมดใน list นั้น
Step 15: แสดง "Total primes: " ตามด้วยความยาวของ list
```
...
```text
เหมือนกันกับแผนแรก คือ ตรวจสอบการเป็นจำนวนเฉพาะจากการหารเลขนั้นด้วย 2 ไปจนถึงเลขจำนวนนั้น ถ้ามีเลขที่หารลงตัว แสดงว่าไม่ใช่จำนวนเฉพาะ
```
