...
```text
โจทย์ให้รับจำนวนคนทั้งหมด N คน รับจำนวน K คือคนที่ 1 จะหยิบของขวัญมาตรวจสอบแล้วส่งให้คนถัดไปอีก K ตรวจสอบเรื่อยๆ และรับค่าตำแหน่งคนที่เป็นขโมยคือ T แล้วให้แสดงจำนวนคนที่ได้พิจารณาของขวัญ
Input:
รับจำนวนเต็ม N แทนจำนวนคนทั้งหมด จำนวนเต็ม K แทนระยะห่างที่ส่งให้คนถัดไป จำนวนเต็ม T แทนตำแหน่งของขโมย
Output:
จำนวนคนที่ได้พิจารณาของขวัญ
Constraints:
การส่งต่อของขวัญจะหยุดลงได้เมื่อเกิด 2 กรณีคือ 1.ของขวัญวนกลับมาที่คนที่ 1 2.ของขวัญถูกขโมยตรวจสอบ โดยจะนับรวมขโมยด้วย
```
...
```text
Step 1: รับค่า N K T
Step 2: กำหนดให้ตัวแปร i มีค่าเป็น 1
Step 3: ตรวจสอบว่าขโมยคือคนที่ 1 ใช่หรือไม่
Step 4: ถ้าใช่ จะแสดงค่า i ออกมา
Step 5: ถ้าไม่ จะนำค่า i มาเข้าลูปโดยเพิ่มค่า i ทีละ 1
Step 6: ภายในลูป จะหาแต่ละตำแหน่งที่ของขวัญถูกส่งต่อไป โดยใช้สูตร position = (1 + i * K) % N
Step 7: ตรวจสอบว่าค่า position เท่ากับ 0 หรือไม่
Step 8: ถ้าใช่ จะเปลี่ยนให้ค่า position เท่ากับ N
Step 9: ตรวจสอบว่าค่า position เท่ากับ T หรือไม่
Step 10: ถ้าใช่ จะบวกเพิ่มค่า i อีก 1 เพราะในสูตรจะยังไม่ได้นับคนที่ 1 แล้วจะหยุดการทำงานของ loop
Step 11: ตรวจสอบว่า position เท่ากับ 1 หรือไม่
Step 12: ถ้าใช่ จะหยุดการทำงานของ loop
Step 13: แสดงค่า i แทนจำนวนคนที่ได้พิจารณาของขวัญ
```
...
```text
เหมือนกันกับแผนแรก คือการใช้สูตร (1 + i * K) % N เพื่อหาค่า i ที่แทนจำนวนคนที่ได้พิจารณาของขวัญ
```
