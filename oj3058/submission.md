...
```text
โจทย์ให้รับจำนวนอิฐก้อนเล็ก ก้อนใหญ่ และความยาวที่ต้องการ แล้วแสดงผลจำนวนอิฐก้อนเล็กที่ต้องใช้น้อยที่สุดในการสร้างสะพานให้ได้ตามความยาวที่รับมา
Input:
บรรทัดที่ 1 รับจำนวนอิฐก้อนเล็กที่มีเป็นจำนวนเต็มบวก
บรรทัดที่ 2 รับจำนวนอิฐก้อนใหญ่ที่มีเป็นจำนวนเต็มบวก
บรรทัดที่ 3 รับค่าความยาวสะพานที่ต้องการสร้างเป็นจำนวนเต็มบวก
Output:
จำนวนอิฐก้อนเล็กที่ต้องใช้น้อยที่สุด ถ้าไม่สามารถสร้างสะพานได้จะแสดงค่า -1
Constraints:
จะต้องใช้อิฐก้อนใหญ่ให้ได้มากที่สุดก่อนจะใช้อิฐก้อนเล็กเสมอ โดยต้องสร้างให้พอดีกับความยาวสะพานที่รับมา
```
...
```text
Step 1: รับค่าจำนวนอิฐก้อนเล็ก
Step 2: รับค่าจำนวนอิฐก้อนใหญ่
Step 3: รับค่าความยาวสะพานที่ต้องการสร้าง
Step 4: หาจำนวนอิฐก้อนใหญ่ที่ต้องใช้ โดยจะใช้จำนวน = ความยาวสะพานที่ต้องการสร้าง หาร 5 แบบปัดเศษลง
Step 5: ถ้าจำนวนอิฐก้อนใหญ่ที่ต้องใช้ > จำนวนอิฐก้อนใหญ่ที่มีอยู่ จะเปลี่ยนค่าให้จำนวนอิฐก้อนใหญ่ที่ต้องใช้ = จำนวนอิฐก้อนใหญ่ที่มีอยู่
Step 6: หาจำนวนอิฐก้อนเล็กที่ต้องใช้ โดยจะใช้จำนวน = ความยาวสะพานที่ต้องการสร้าง - ( จำนวนอิฐก้อนใหญ่ที่ต้องใช้ * 5 )
Step 7: ตรวจสอบว่าจำนวนอิฐก้อนเล็กที่ต้องใช้ > จำนวนอิฐก้อนเล็กที่มีอยู่ หรือไม่
Step 8: ถ้าใช่ จะแสดงผลออกมาเป็น -1
Step 9: ถ้าไม่ จะแสดงผลออกมาเป็น จำนวนอิฐก้อนเล็กที่ต้องใช้
```
...
```text
เหมือนกันกับแผนแรก คือหาจำนวนอิฐก้อนใหญ่ที่สามารถใช้ได้มากที่สุดก่อน หาความยาวที่ได้จากอิฐก้อนใหญ่แล้วนำมาลบกับความยาวทั้งหมดที่ต้องการ จึงจะได้ความยาวที่ต้องใช้สำหรับอิฐก้อนเล็ก
```
...
```text
เป็นกรณีที่มีอิฐก้อนใหญ่น้อยกว่าที่จำเป็นต้องใช้
```
...
```text
เป็นกรณีที่มีอิฐก้อนใหญ่เยอะกว่าที่จำเป็นต้องใช้
```
...
```text
เป็นกรณีที่มีอิฐก้อนเล็กน้อยกว่าที่จำเป็นต้องใช้
```
