...
```text
โจทย์ให้รับจำนวนเต็ม N ครั้งของการกระทำ และตามด้วยคำสั่ง + หรือ - คำนวณแล้วแสดงคะแนนรวมสุดท้ายออกมา
Input:
บรรทัดที่ 1 จำนวนเต็ม N แทนจำนวนครั้งของการกระทำ
บรรทัดที่สองถึง N รับคำสั่งเป็น + หรือ -
Output:
คะแนนรวมทั้งหมด
Constraints:
คำสั่ง + คือเพิ่ม 10 คะแนน คำสั่ง - คือลด 5 คะแนน
```
...
```text
Step 1: รับจำนวน N ครั้งของการกระทำ
Step 2: กำหนดให้ค่าคะแนนรวมคือ 0
Step 3: loop รับคำสั่งจำนวน N ครั้ง
Step 4: ภานใน loop ตรวจสอบว่าคำสั่งคือ + หรือไม่
Step 5: ถ้าใช่ ให้คะแนนเพิ่มขึ้น 10 คะแนน
Step 6: ถ้าไม่ ให้คะแนนลดลง 5 คะแนน
Step 7: หลังจากหมด loop แล้ว จะแสดงคะแนนรวมทั้งหมด
```
...
```text
เหมือนกันกับแผนแรก คือตรวจสอบคำสั่งให้ครบ N รอบ แล้วเพิ่มหรือลดคะแนนรวมตามคำสั่งนั้นๆ
```
