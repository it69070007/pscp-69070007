...
```text
โจทย์ให้รับจำนวนเต็มบวกมา 1 จำนวน แล้วให้แสดงผลเลขที่หารด้วย 10 ลงตัว ตั้งแต่จำนวนที่รับมาไปถึง 0
Input:
จำนวนเต็มบวก 1 จำนวน
Output:
จำนวนเต็มบวกตั้งแต่จำนวนที่รับมาถึง 0 ที่หารด้วย 10 ลงตัว คั่นทุกตัวด้วยช่องว่าง
Constraints:
จำนวนที่รับมาเป็นจำนวนเต็มบวก
```
...
```text
Step 1: รับค่าจำนวนเต็มบวก
Step 2: นำจำนวนที่รับมาเข้าลูปจนกว่าเลขนั้นจะน้อยกว่า 0
Step 3: ภายในลูปจะตรวจสอบว่าเลขนั้นหาร 10 ลงตัว หรือไม่
Step 4: ถ้าใช่ จะแสดงค่านั้นออกมาคั่นด้วยช่องว่าง และเปลี่ยนค่านั้นให้เป็น ค่านั้นลบ 10
Step 5: ถ้าไม่ จะเปลี่ยนค่านั้นให้เป็น ค่านั้นลบ 1
```
...
```text
เหมือนกันกับแผนแรก คือการนำค่าที่รับมาลดลงทีละ 1 จนกว่าค่านั้นจะหาร 10 ลงตัว จึงจะแสดงผลเลขที่หาร 10 ลงตัว และลดค่านั้นลงทีละ 10
```
